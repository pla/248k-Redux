...
local function sprite(name)
    return '__248k-Redux-graphics__/ressources/fusion/fu_exchanger/fu_exchanger_'..name
end
...
data:extend({
        ...
        fluid_boxes = {
            ...
            { 
              ...
              volume = 100,
                ...
                pipe_connections =
                {
                  {flow_direction = "input", position = {-1.5, 1.5}, direction = 12}
                },
                production_type = "input"
              },
            { 
            ...
            },
            {
              ...
              pipe_connections =
              {
                {flow_direction = "output", position = {1.5, 1.5}, direction = 4}
              },
              production_type = "output"
            },
        },
    ...
    circuit_connector = circuit_connector_definitions.create_vector(
      ...
      {
        { variation =  0, main_offset = util.by_pixel(-49.125,  23.75), shadow_offset = util.by_pixel(-49.125,  23.75), show_shadow = true },
        { variation =  0, main_offset = util.by_pixel(-49.125,  23.75), shadow_offset = util.by_pixel(-49.125,  23.75), show_shadow = true },
        { variation =  0, main_offset = util.by_pixel(-49.125,  23.75), shadow_offset = util.by_pixel(-49.125,  23.75), show_shadow = true },
        { variation =  0, main_offset = util.by_pixel(-49.125,  23.75), shadow_offset = util.by_pixel(-49.125,  23.75), show_shadow = true },
      }
