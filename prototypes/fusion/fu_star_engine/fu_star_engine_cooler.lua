...
local function sprite(name)
    return '__248k-Redux-graphics__/ressources/fusion/fu_star_engine/fu_star_engine_cooler/fu_star_engine_cooler_'..name
end
    ...
    --prototype
    {
        ...
        circuit_connector = circuit_connector_definitions.create_vector(
          universal_connector_template, 
            {
              { variation =  4, main_offset = util.by_pixel( -60, -260.125), shadow_offset = util.by_pixel( -60, -260.125), show_shadow = true },
              { variation =  4, main_offset = util.by_pixel( -60, -260.125), shadow_offset = util.by_pixel( -60, -260.125), show_shadow = true },
              { variation =  4, main_offset = util.by_pixel( -60, -260.125), shadow_offset = util.by_pixel( -60, -260.125), show_shadow = true },
              { variation =  4, main_offset = util.by_pixel( -60, -260.125), shadow_offset = util.by_pixel( -60, -260.125), show_shadow = true },
            }
