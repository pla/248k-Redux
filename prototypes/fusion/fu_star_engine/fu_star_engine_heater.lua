...
local function sprite(name)
    return '__248k-Redux-graphics__/ressources/fusion/fu_star_engine/fu_star_engine_heater/fu_star_engine_heater_'..name
end
    ...
    --prototype
    {
        ...
        circuit_connector = circuit_connector_definitions.create_vector(
          universal_connector_template, 
            {
              { variation =  6, main_offset = util.by_pixel( -260.125, 30), shadow_offset = util.by_pixel( -260.125, 30), show_shadow = true },
              { variation =  6, main_offset = util.by_pixel( -260.125, 30), shadow_offset = util.by_pixel( -260.125, 30), show_shadow = true },
              { variation =  6, main_offset = util.by_pixel( -260.125, 30), shadow_offset = util.by_pixel( -260.125, 30), show_shadow = true },
              { variation =  6, main_offset = util.by_pixel( -260.125, 30), shadow_offset = util.by_pixel( -260.125, 30), show_shadow = true },
            }
