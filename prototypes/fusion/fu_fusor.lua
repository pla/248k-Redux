...
local function sprite(name)
    return '__248k-Redux-graphics__/ressources/fusion/fu_fusor/fu_fusor_'..name
end
...
data:extend({
        ...
        fluid_boxes = {
            {
              ...
              pipe_connections =
              {
                {flow_direction = "input", position = {-1.5, -2}, direction = 0},
              },
    ...
    circuit_connector = circuit_connector_definitions.create_vector(
      ...
      {
        { variation = 25, main_offset = util.by_pixel(-59.5,  16.625), shadow_offset = util.by_pixel(-59.5,  16.625), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-59.5,  16.625), shadow_offset = util.by_pixel(-59.5,  16.625), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-59.5,  16.625), shadow_offset = util.by_pixel(-59.5,  16.625), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-59.5,  16.625), shadow_offset = util.by_pixel(-59.5,  16.625), show_shadow = true },
      }
