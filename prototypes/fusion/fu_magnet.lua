...
local function sprite(name)
    return '__248k-Redux-graphics__/ressources/fusion/fu_magnet/fu_magnet_'..name
end
...
data:extend({
  --prototype
  {
    ...
    circuit_connector = circuit_connector_definitions.create_vector(
      ...
      {
        { variation = 25, main_offset = util.by_pixel(-99.875,  77.5), shadow_offset = util.by_pixel(-99.875,  77.5), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-99.875,  77.5), shadow_offset = util.by_pixel(-99.875,  77.5), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-99.875,  77.5), shadow_offset = util.by_pixel(-99.875,  77.5), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-99.875,  77.5), shadow_offset = util.by_pixel(-99.875,  77.5), show_shadow = true },
      }
