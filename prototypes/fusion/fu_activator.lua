...
local function sprite(name)
    return '__248k-Redux__/ressources/fusion/fu_activator/fu_activator_'..name
end
    ...
    --prototype
    {
        ...
        fluid_boxes = {
            { 
                ...
                pipe_connections =
                {
                  {flow_direction = "input", position = {-1, 0}, direction = 0}
                },
            ...
            { 
              ...
              pipe_connections =
              {
                {flow_direction = "output", position = {1, 0}, direction = 0}
              },
