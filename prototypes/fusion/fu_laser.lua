...
local function sprite(name)
    return '__248k-Redux__/ressources/fusion/fu_laser/fu_laser_'..name
end
...
data:extend({
  --prototype
  {
    ...
    circuit_connector = circuit_connector_definitions.create_vector(
      ...
      {
        { variation = 25, main_offset = util.by_pixel(-99.375,  72.25), shadow_offset = util.by_pixel(-99.375,  72.25), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-99.375,  72.25), shadow_offset = util.by_pixel(-99.375,  72.25), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-99.375,  72.25), shadow_offset = util.by_pixel(-99.375,  72.25), show_shadow = true },
        { variation = 25, main_offset = util.by_pixel(-99.375,  72.25), shadow_offset = util.by_pixel(-99.375,  72.25), show_shadow = true },
      }
