...
local function sprite(name)
    return '__248k-Redux-graphics__/ressources/gravitation/gr_charger/gr_charger_'..name
end
...
data:extend({
    ...
    circuit_connector = circuit_connector_definitions.create_vector(
      ...
      {
        { variation =  0, main_offset = util.by_pixel(-33.125,  14.875), shadow_offset = util.by_pixel(-33.125,  14.875), show_shadow = true },
        { variation =  0, main_offset = util.by_pixel(-33.125,  14.875), shadow_offset = util.by_pixel(-33.125,  14.875), show_shadow = true },
        { variation =  0, main_offset = util.by_pixel(-33.125,  14.875), shadow_offset = util.by_pixel(-33.125,  14.875), show_shadow = true },
        { variation =  0, main_offset = util.by_pixel(-33.125,  14.875), shadow_offset = util.by_pixel(-33.125,  14.875), show_shadow = true },
      }
