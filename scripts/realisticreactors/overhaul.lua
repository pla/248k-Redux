...
data:extend({
    {
        name = 'fi_test_fuel',
        type = 'item',
        icon = '__248k-Redux-graphics__/ressources/fission/fi_fuel/fi_fuel_test_item.png',
        icon_size = 64,
        stack_size = 20,
    ...
    },
    {
        ...
        type = 'item',
        icon = '__248k-Redux-graphics__/ressources/fission/fi_fuel/fi_fuel_test_used_item.png',
        icon_size = 64,
        stack_size = 100,
        subgroup = 'fi_item_subgroup_b',
        order = 'x-b',
    },
    {
        name = 'fi_tech_fuel',
        type = 'item',
        icon = '__248k-Redux-graphics__/ressources/fission/fi_fuel/fi_fuel_tech_item.png',
        icon_size = 64,
        stack_size = 100,
        subgroup = 'fi_item_subgroup_b',
        order = 'x-c',
    ...
    },
    {
        ...
        type = 'technology',
        icon = '__248k-Redux-graphics__/ressources/techs/fi_solid_reactor_tech.png',
        icon_size = 128,
    ...
    },
    {
        ...
        energy_usage = "1W",
        animation = {
            filename = '__248k-Redux-graphics__/ressources/fission/fi_solid_reactor/fi_solid_reactor_entity_animation.png',
            width = 960,
            height = 960,
            shift = {0, 0},
            scale = 0.2,
          ...
          working_visualisations = {
            {
                animation = {
                    filename = '__248k-Redux-graphics__/ressources/fission/fi_solid_reactor/fi_solid_reactor_entity_animation_2.png',
                    width = 960,
                    height = 960,
                    shift = {0, 0},
                    scale = 0.2,
