...
{
  checkboard = false,
  save = "__248k-Redux-graphics__/ressources/menu_simulation/248k_menu_1.zip",
  length = 60*25,
  init = [[
...
{
  checkboard = false,
  save = "__248k-Redux-graphics__/ressources/menu_simulation/248k_menu_2.zip",
  length = 60*25,
  init = [[
...
{
  checkboard = false,
  save = "__248k-Redux-graphics__/ressources/menu_simulation/248k_menu_3.zip",
  length = 60*25,
  init = [[
...
{
  checkboard = false,
  save = "__248k-Redux-graphics__/ressources/menu_simulation/248k_menu_6.zip",
  length = 60*25,
  init = [[
