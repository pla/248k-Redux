...
se_delivery_cannon_recipes["el_energy_crystal_item"] = {name= "el_energy_crystal_item"}
se_delivery_cannon_recipes["el_lithium_item"] = {name= "el_lithium_item"}
se_delivery_cannon_recipes["fi_thorium232_item"] = {name= "fi_thorium232_item"}
se_delivery_cannon_recipes["fi_uranium233_item"] = {name= "fi_uranium233_item"}
se_delivery_cannon_recipes["fi_plutonium239_item"] = {name= "fi_plutonium239_item"}
se_delivery_cannon_recipes["fi_materials_glass"] = {name= "fi_materials_glass"}
se_delivery_cannon_recipes["fi_materials_gold"] = {name= "fi_materials_gold"}
se_delivery_cannon_recipes["fi_materials_neodym"] = {name= "fi_materials_neodym"}
se_delivery_cannon_recipes["fi_materials_titan"] = {name= "fi_materials_titan"}
se_delivery_cannon_recipes["fi_materials_GFK"] = {name= "fi_materials_GFK"}
se_delivery_cannon_recipes["fi_materials_NFK"] = {name= "fi_materials_NFK"}
se_delivery_cannon_recipes["fi_energy_crystal_item"] = {name= "fi_energy_crystal_item"}
se_delivery_cannon_recipes["fu_materials_energy_crystal"] = {name= "fu_materials_energy_crystal"}
se_delivery_cannon_recipes["fu_materials_refined_crystal"] = {name= "fu_materials_refined_crystal"}
